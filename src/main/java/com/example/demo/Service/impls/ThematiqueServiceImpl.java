...
public class ThematiqueServiceImpl implements ThematiqueService {
	...
	public void deleteById(Integer id) {
		try {
//			absenceRepository.deleteByThematiqueId(id);
//			evaluationRepository.deleteByThematiqueId(id);
	...
	private void updateGroupeEntities(Thematique thematique) {
		...
		// Add new groupes if nbrGroupe is increased
			...
			groupeRepository
					.saveAll(groupes.subList(groupes.size() - (updatedNbrGroupe - groupes.size()), groupes.size()));
		}
